...
import com.om.sitaramfrem.databinding.FragmentPendingOrderBinding;
...
public class FragmentPendingOrder extends Fragment {
    ...
    private static final String TAG = FragmentPendingOrder.class.getSimpleName();

    public FragmentPendingOrder() {
        // Required empty public constructor
    }

    public static FragmentPendingOrder newInstance() {
        FragmentPendingOrder fragment = new FragmentPendingOrder();
        return fragment;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.mFABAdd.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    @Subscribe
    public void updateList(UpdateOrderList updateOrderList) {
        initSuperRecyclerView();
    }
