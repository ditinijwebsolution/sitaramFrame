...
public class FragmentInprogressOrder extends Fragment {
    ...
    private static final String TAG = FragmentInprogressOrder.class.getSimpleName();

    public FragmentInprogressOrder() {
        // Required empty public constructor
    }

    public static FragmentInprogressOrder newInstance() {
        FragmentInprogressOrder fragment = new FragmentInprogressOrder();
        return fragment;
    }
