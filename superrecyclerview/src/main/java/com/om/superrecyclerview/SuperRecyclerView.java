package com.om.superrecyclerview;
...
import com.om.superrecyclerview.swipe.SwipeDismissRecyclerViewTouchListener;
import com.om.superrecyclerview.util.FloatUtil;
...
public class SuperRecyclerView extends FrameLayout {
    ...
    private void processOnMore() {
        ...
        if ((visibleItemCount + firstVisibleItemPosition) >= totalItemCount && !isLoadingMore) {
            isLoadingMore = true;
    ...
    private int getFirstVisibleItemPosition(RecyclerView.LayoutManager layoutManager) {
        ...
        switch (layoutManagerType) {
            ...
            case GRID:
                ...
                break;
            case STAGGERED_GRID:
                firstVisibleItemPosition = getFirstPoscaseStaggeredGrid(layoutManager);
                break;
        }
    ...
    private int getFirstPoscaseStaggeredGrid(RecyclerView.LayoutManager layoutManager) {
        StaggeredGridLayoutManager staggeredGridLayoutManager = (StaggeredGridLayoutManager) layoutManager;
        if (lastScrollPositions == null)
            lastScrollPositions = new int[staggeredGridLayoutManager.getSpanCount()];
